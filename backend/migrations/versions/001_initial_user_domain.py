...
def upgrade() -> None:
    ...
    op.create_index(op.f('idx_dietary_preferences_name'), 'dietary_preferences', ['name'], unique=True)
    ...
    op.create_index(op.f('idx_activity_levels_name'), 'activity_levels', ['name'], unique=True)
    ...
    op.create_index(op.f('idx_user_profiles_phone_number'), 'user_profiles', ['phone_number'], unique=True)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['dietary_preference_id'], ['dietary_preferences.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('idx_dietary_preferences_name'), table_name='dietary_preferences')
